(function ($) {
    ...
    Modal.fn = $.Modal.prototype = {
        ...
        build: function () {
            ...
            this.$modalBox = $('<div class="modal-box ' + this.opts.cn + '" />');
            ...
            if(this.opts.title){
                ...
                this.$modalBody.addClass('with_header');
            }
        ...
        buildOverlay: function () {
            ...
            this.$modalOverlay = $('<div id="modal-overlay" />');
            ...
            if (typeof this.opts.content == 'object' || this.opts.content.search('#') === 0) {
                ...
                $.ajax({
                    ...
                    success: $.proxy(function (data) {
                        ...
                        //add ajax loading form
                        $('.md-form', this.$modalBody).uForm();
                        fancy();
                    }, this)
                });
        ...
        enableEvents: function () {
            ...
            this.$modalOverlay.on('click.tools.modal', $.proxy(this.close, this));
