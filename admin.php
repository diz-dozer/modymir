...
if (isset($_GET["do"])) {
    ...
    switch ($eaction) {
            ...
            if (isset($_POST["save"]) && $_POST["name"]) { //save changes
                                ...
                                <tr>
                                    ...
                                    <td class="head toph"><?php
                                        ...
                                        ?>: <b><?php
                                            ...
                                            ?></b></td>
                                    <td class="head"><img src="data/admin/sep2.gif" alt=""></td>
                                    <td class="head last toph" width="100%">
                                        <a href="<?php echo ADMIN_FILE; ?>?order_search_type=SearchByStatusID&amp;checkbox_order_status_<?php
                                        ...
                                        <div class="dvmenu">
                                            <table class="adn">
                                                <tr>
                                                    ...
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=catalog&amp;sub=products_categories"><?php
                                            ...
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=catalog&amp;sub=dbsync"><?php
                                            ...
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=catalog&amp;sub=extra"><?php
                                            ...
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=catalog&amp;sub=special"><?php
                                            ...
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=catalog&amp;sub=excel_import"><?php
                                            ...
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=catalog&amp;sub=excel_export"><?php
                                        ...
                                        <div class="dvmenu">
                                            <table class="adn">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=custord&amp;sub=new_orders"><?php
                                            ...
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=custord&amp;sub=subscribers"><?php
                                            ...
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=custord&amp;sub=order_statuses"><?php
                                            ...
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=custord&amp;sub=reg_fields"><?php
                                            ...
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=custord&amp;sub=discounts"><?php
                                            ...
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=custord&amp;sub=aux_pages"><?php
                                                            echo ADMIN_TX7;
                                                            ?></a></td>
                                                </tr>
                                            </table>
                                        ...
                                        <div class="dvmenu">
                                            <table class="adn">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=conf&amp;sub=setting&amp;settings_groupID=2"><?php
                                            ...
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=conf&amp;sub=currencies"><?php
                                            ...
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=conf&amp;sub=shipping"><?php
                                            ...
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=conf&amp;sub=payment"><?php
                                            ...
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=conf&amp;sub=blocks_edit"><?php
                                                            echo ADMIN_TX20;
                                                            ?></a></td>
                                                </tr>
                                            </table>
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=conf&amp;sub=admin_edit"><?php
                                        ...
                                        <div class="dvmenu">
                                            <table class="adn">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=modules&amp;sub=news"><?php
                                                            echo ADMIN_NEWS;
                                                            ?></a></td>
                                                </tr>
                                            </table>
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=modules&amp;sub=survey"><?php
                                                            echo ADMIN_VOTING;
                                                            ?></a></td>
                                                </tr>
                                            </table>
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=modules&amp;sub=shipping"><?php
                                            ...
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=modules&amp;sub=payment"><?php
                                            ...
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=modules&amp;sub=linkexchange"><?php
                                            ...
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=modules&amp;sub=yandex"><?php
                                            ...
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=custord&amp;sub=affiliate"><?php echo STRING_AFFILIATE_PROGRAM; ?></a>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                        ...
                                        <div class="dvmenu">
                                            <table class="adn">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=reports&amp;sub=category_viewed_times"><?php
                                            ...
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=reports&amp;sub=customer_log"><?php
                                            ...
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=reports&amp;sub=information"><?php
                                            ...
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=reports&amp;sub=coming"><?php
                                                            echo ADMIN_COMING;
                                                            ?></a></td>
                                                </tr>
                                            </table>
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=reports&amp;sub=security"><?php
                                                            echo ADMIN_SECURITY;
                                                            ?></a></td>
                                                </tr>
                                            </table>
                                        ...
                                        <div class="dvmenu">
                                            <table class="adn">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?login=&amp;first_name=&amp;last_name=&amp;email=&amp;groupID=0&amp;fActState=-1&amp;dpt=custord&amp;sub=custlist&amp;search=Find"><?php
                                            ...
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=custord&amp;sub=custgroup"><?php
                                            ...
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=conf&amp;sub=countries"><?php
                                            ...
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=conf&amp;sub=zones"><?php
                                            ...
                                            <table class="adn topj">
                                                <tr>
                                                    <td><img src="data/admin/drs.gif" alt=""></td>
                                                    <td width="100%">
                                                        <a href="<?php echo ADMIN_FILE; ?>?dpt=catalog&amp;sub=discuss"><?php
                                                    ...
                                                    <table class="adn">
                                                        <tr>
                                                            <td class="nbc2"><span class="titlecol"><?php
                                                                    echo $title;
                                                                    ?></span></td>
                                                            <td align="right" valign="middle" id="preproc"></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <table class="adn">
                                                                ...
                                                                <td align="left"><?php
                                                                    ...
                                                                    ?>>
                                                                        ...
                                                                        if (CONF_FULLY_EXPAND_CATEGORIES_IN_ADMIN_MODE == 1)
                                                                            echo "<option value=\"1\">" . ADMIN_CATEGORY_ROOT .
                                                                                "</option>";
                                                            ...
                                                            <tr class="lins">
                                                                <td align="left"><?php
                                                                    ...
                                                                    echo str_replace("\"", "&quot;", $t);
                                                                    ?>" style="width: 590px;" class="textp"></td>
                                                            </tr>
                                                            <tr class="lins">
                                                                <td align="left">
                                                                    <table class="adw houp">
                                                                        <tr>
                                                                            <td align="center"><?php
                                                                            ...
                                                                            <td>
                                                                                <img src="data/admin/plus.gif" alt="" style="cursor: pointer" onclick="document.getElementById('MainForm').submit()">
                                                                            </td>
                                                                            <td>&nbsp;&nbsp;&nbsp;<?php
                ...
                ?>';
                                                        ...
                                                        <table class="adn">
                                                            <tr>
                                                                <td class="separ">
                                                                    <img src="data/admin/pixel.gif" alt="" class="sep">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="se5"></td>
                                                            ...
                                                            <tr class="lins">
                                                                <td align="left">
                                                                    <table class="adn houp">
                                                                        <tr>
                                                                            <td align="left">
                                                                                <input type="checkbox" name="allow_products_comparison" id="allow_products_comparison" value='1'
                                                                                    <?php
                                                                            ...
                                                                            <td align="left" width="100%">
                                                                                <label for="allow_products_comparison"> &nbsp;<?php
                                                                                    echo ADMIN_ALLOW_PRODUCTS_COMPARISON;
                                                                                    ?></label></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="left" valign="middle" nowrap>
                                                                                <input type="checkbox" name="allow_products_search" id="allow_products_search" value='1'
                                                                                    <?php
                                                                                    ...
                                                                                    ></td>
                                                                            <td align="left">
                                                                                <label for="allow_products_search"> &nbsp;<?php
                                                                                    echo ADMIN_ALLOW_SEARCH_IN_CATEGORY;
                                                                                    ?></label></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="left" valign="middle">
                                                                                <input type="checkbox" name='show_subcategories_products' id="show_subcategories_products" value='1'
                                                                                    <?php
                                                                                    ...
                                                                                    ></td>
                                                                            <td align="left">
                                                                                <label for="show_subcategories_products"> &nbsp;<?php
                                                        ...
                                                        <table class="adn">
                                                            ...
                                                            <tr class="lins">
                                                                <td align=left>
                                                                    <a href="#" class="inl" onClick="SelectParametrsHideTable(); return false"><?php
                                                                    ...
                                                                    <table class="adw" style="margin: 4px 5px;">
                                                                        ...
                                                                        if (count($options) >= 1) {
                                                                            foreach ($options as $option) {
                                                                                ?>
                                                                                <tr>
                                                                                    <td align="center" valign="middle" class="cssel">
                                                                                        <input type="checkbox" name='checkbox_param_<?php
                                                                                        ...
                                                                                        ?>'
                                                                                            ...
                                                                                            ?>
                                                                                               ...
                                                                                               echo $option["optionID"];
                                                                                               ?>()'></td>
                                                                                    <td colspan="3" align="left" valign="middle" class="toph3"><?php
                                                                                        echo $option["name"];
                                                                                        ?></td>
                                                                                </tr>
                                                                                <?php
                                                                                if (count($option["variants"]) != 0) {
                                                                                    ...
                                                                                    <tr>
                                                                                        <td></td>
                                                                                        <td align="center" valign="middle" class="cssel">
                                                                                            <input type="radio" name='select_arbitrarily_<?php
                                                                                            echo $option["optionID"];
                                                                                            ...
                                                                                            echo $option["optionID"];
                                                                                            ?>()'></td>
                                                                                        <td colspan="2" align="left" valign="middle" class="toph3"><?php
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="center" valign="middle" class="cssel">
                                                                                            ...
                                                                                            echo $option["optionID"];
                                                                                            ?>()'></td>
                                                                                        <td colspan="2" class="toph3" align="left" valign="middle"><?php
                                                                                    ...
                                                                                    foreach ($option["variants"] as $variant) {
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td></td>
                                                                                            <td align="center" valign="middle" class="cssel">
                                                                                                <input type="checkbox" name='checkbox_variant_<?php
                                                                                                ...
                                                                                                ?>'
                                                                                                    ...
                                                                                                    ?>
                                                                                                    ></td>
                                                                                            <td class="toph3" align="left" valign="middle" width="100%"><?php
                    ...
                    ?>fckeditor/";
                                                            ...
                                                            <tr>
                                                                <td width="50%">
                                                                    <table class="adn">
                                                                        ...
                                                                        <tr>
                                                                            <td align="left">
                                                                        <textarea name='meta_d' id="meta_d" class="adminall" style="margin-right: 38px;"><?php
                                                                            echo $meta_d;
                                                                            ?></textarea></td>
                                                                        </tr>
                                                                    </table>
                                                                ...
                                                                <td width="50%">
                                                                    <table class="adn">
                                                                        ...
                                                                        <tr>
                                                                            <td align="left">
                                                                        <textarea name='meta_k' id="meta_k" class="adminall"><?php
                                                                            echo $meta_k;
                                                                            ?></textarea></td>
                                                                        </tr>
                                                                    </table>
                                                        ...
                                                        ?><input type="hidden" name="save" value="yes"></form>
                                                </td>
                                            </tr>
                                        </table>
                                        <table class="adn">
                                        ...
                                        <table class="adn">
                                            <tr>
                                                <td class="help"><span class="titlecol2"><?php
                                                        echo USEFUL_FOR_YOU;
                                                        ?></span>

                                                    <div class="helptext"><?php
                                                        echo NOTE31;
                                                        ?><br><br><?php
                                                        echo NOTE34;
                                                        ?></div>
        ...
        case 'prod':
            ...
            ?>
                                                            value='1'>&nbsp;&nbsp;<?php echo ADMIN_FREE_SHIPPING; ?>
                                                    </td>
                                                </tr>
                                                <?php
            ...
            ?>" style="width: 100px;" class="textp"></td>
                                                    <td align="left">
                                                        <input type="text" name="shipping_freight" value="<?php
            ...
            ?>
                                                ...
                                                <tr class="lins">
                                                    <td align="left">
                                                        <input type="text" name="min_order_amount" value="<?php
            ...
            <?php
                ...
                ?>
                <td align="left">
                    <input type="hidden" name='in_stock' value="<?php
                    echo $product["in_stock"];
                    ?>"></td>
            <?php
            }
            ?>
                                            ...
                                            <table class="adn">
                                                <tr>
                                                    <td class="separ">
                                                        <img src="data/admin/pixel.gif" alt="" class="sep"></td>
                                                </tr>
                                                <tr>
                                                    <td class="se5"></td>
                                                </tr>
            ...
            ?><?php
            if ($_GET["productID"])
                echo "&nbsp;&nbsp;|&nbsp;&nbsp;<a href=\"#\" onClick=\"confirmDeletep('" .
            ...
            ?></td>
                                                ...
                                                <tr class="lins">
                                                    <td align="center" valign="middle">
                                                        <input type=checkbox name='ProductIsProgram' value='1' onclick='ProductIsProgramHandler();'
                                                            <?php
            ...
            ?>
                                                    ...
                                                    <td align="left" valign="middle">
                                                        <input type=text name='eproduct_download_times' value='<?php echo $product["eproduct_download_times"]; ?>' class="textp">
                                                    </td>
                                                    <td align="left" valign="middle">
                                                        <input type='file' name='eproduct_filename' value='<?php echo $product["eproduct_filename"]; ?>' class="file" size="18">
                                                    </td>
                                                    <td align="center" valign="middle">
                                                        <img src="data/admin/plus.gif" alt="" style="cursor: pointer" onclick="document.getElementById('save_product_for_file').value='1',document.getElementById('MainForm').submit()">
                                                    </td>
                                                </tr>
                                            </table>
                                            <table class="adn">
            ...
            ?></span></td>
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <textarea name='meta_description' id="meta_description" class="adminall" style="margin-right: 38px;"><?php
            ...
            ?></span></td>
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <textarea name='meta_keywords' id="meta_keywords" class="adminall"><?php
            ...
            ?>
                                                    ...
                                                    <td align="center" valign="middle">
                                                        <input id="pic1" onchange="confstatus(this,'pic2'),confstatus(this,'pic3');" type="file" name="new_filename" class="file" size="13">
                                                    </td>
                                                    <td align="center" valign="middle">
                                                        <input disabled id="pic2" type="file" name="new_thumbnail" class="file" size="13">
                                                    </td>
                                                    <td align="center" valign="middle">
                                                        <input disabled id="pic3" type="file" name="new_enlarged" class="file" size="13">
                                                    </td>
                                                    <td align="center" valign="middle">
                                                        <img src="data/admin/plus.gif" alt="" style="cursor: pointer" onclick="upd2(),document.getElementById('MainForm').submit()">
                                                    </td>
                                                </tr>
                                            </table>
                                            <table class="adn">
            ...
            if (isset($_GET["productID"])) {
                ...
                <table class="adn">
                    ...
                    $cnt = db_fetch_row($q);
                    if ($cnt[0] == 0)
                        echo "<tr class=\"lins\"><td align=\"center\" height=\"20\">" . STRING_EMPTY_CATEGORY3 .
                            "</td></tr>";
                    else {
            ...
            if (count($options) >= 1) {
                foreach ($options as $option) {
                    ...
                    <tr class="liney">
                        <td align="center" valign="middle">
                            <input name='option_radio_type_<?php
                    ...
                    <tr class="liney">
                        <td align="center" valign="middle">
                            ...
                            ?>, 'ANY_VALUE' )"></td>
                        <td align="center" valign="middle">
                            <input type="text" name='option_value_<?php
                            echo $option_row["optionID"]
                    ...
                    <tr class="liney">
                        <td align="center" valign="middle">
                            ...
                            ?>, 'N_VALUES' )"></td>
                        <td align="center" valign="middle">
                            <a href="#" class="inl" name="configurator_<?php
                            echo $option_row['optionID']
                        ...
                        <td align="left" valign="middle"><?php
                            ...
                            <SCRIPT type="text/javascript">
                                ...
                                if ($value_row["option_type"] == 0)
                                    echo ("SetOptionValueTypeRadioButton( " . $option_row["optionID"] .
                                    ", 'ANY_VALUE' );");
                                else
                            ...
                            <table class="adn">
                                <tr class="liney">
                                    <td align="left"><?php
                                        ...
                                        ?></td>
                                    <td align="right">
                                        <img src="data/admin/mines.gif" alt="" style="cursor: pointer;" onclick="confirmDeletep('<?php
            ...
            if (count($cats) >= 1) {
                ...
                <tr class="liney">
                    <td width="100%" align=right><b><?php
                            ...
                            ?></select>&nbsp;</td>
                    <td>
                        <img src="data/admin/ret.gif" alt="" style="cursor: pointer;" onclick="upd3(),document.getElementById('MainForm').submit()">
                    </td>
                </tr>
            <?php
            }
