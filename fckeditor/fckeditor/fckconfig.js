...
['Source','-','NewPage','-','Cut','Copy','Paste','PasteText','PasteWord','-','Undo','Redo','-','Find','Replace','-','SelectAll','RemoveFormat','-','FitWindow','ShowBlocks'],
'/',
['Bold','Italic','Underline','-','Subscript','Superscript','-','OrderedList','UnorderedList','-','Outdent','Indent','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','Link','Unlink','-','Anchor','Image','Flash','Table','Rule','SpecialChar'],
'/',
['Style','FontFormat','FontName','FontSize','TextColor','BGColor']
] ;
FCKConfig.ToolbarSets["Basicrr"] = [
        ['Source','Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','-','About']
] ;

FCKConfig.ToolbarSets["Basic"] = [
['Source','-','NewPage','-','Cut','Copy','PasteText','-','Undo','Redo','-','Bold','Italic','Underline','-','OrderedList','UnorderedList','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','Link','Unlink','-','SelectAll','RemoveFormat','FitWindow','-','About'],
] ;