            ...
            <td class="hdbtop" align="left">
                ...
                <table cellspacing="0" cellpadding="0" width="70%" align="center">
                    {section name=y loop=$survey_answers}
                        <tr>
                            <td colspan="2" style="padding: 8px 0 3px 0;">
                                <b>{$survey_answers[y]}</b>&nbsp;&nbsp;({$smarty.const.STRING_VOTES}: {$survey_results[y]})
                            </td>
                        </tr>
                        <tr>
                            <td width="99%" style="background: url('data/{$smarty.const.TPL}/tonel.gif')">
                                <img src="data/{$smarty.const.TPL}/mainbar.gif" height="11" alt="" width="{if $voters_count ne 0}{math equation="round(100 * $survey_results[y] / $voters_count)"}{else}0{/if}%">
                            </td>
                            <td>&nbsp;&nbsp;<b>{if $voters_count ne 0}{math equation="round(100 * $survey_results[y] / $voters_count)"}{else}0{/if}%</b>
                            </td>
                        </tr>
                    {/section}
                </table>
