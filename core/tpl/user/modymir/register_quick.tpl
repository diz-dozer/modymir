{strip}
    ...
    {include file='mod/header.tpl' header=$postheader}
                    ...
                    <table cellspacing="0" cellpadding="0" align="center">
                        <tr>
                            <td align="right" valign="middle">
                                <span class="error">*</span> {$smarty.const.CUSTOMER_FIRST_NAME}:&nbsp;</td>
                            <td valign="middle" align="left">
                                <input type="text" name="first_name" value="{$first_name}" style="width: 220px;"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td align="right" valign="middle">
                                <span class="error">*</span> {$smarty.const.CUSTOMER_LAST_NAME}:&nbsp;</td>
                            <td valign="middle" align="left">
                                <input type="text" name="last_name" value="{$last_name}" style="width: 220px;"></td>
                        </tr>
                        <tr>
                            <td colspan="2" style="height: 6px;"></td>
                        </tr>
                        ...
                        {section name=i loop=$additional_fields}
                            <tr>
                                <td align="right" valign="middle">{if $additional_fields[i].reg_field_required}<span class="error">*</span> {/if}{$additional_fields[i].reg_field_name}:&nbsp;
                                </td>
                                <td valign="middle" align="left">
                                    <input type='text' name='additional_field_{$additional_fields[i].reg_field_ID}' value='{$additional_field_values[i].reg_field_value}' style="width: 220px;">
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" style="height: 6px;"></td>
                        ...
                        {if $smarty.const.CONF_ACTIVE_ORDER eq 1 or $smarty.const.CONF_EMAIL_ORDER_SEND eq 1}
                            <tr>
                                <td align="right" valign="middle">
                                    <span class="error">*</span> {$smarty.const.CUSTOMER_EMAIL}:&nbsp;</td>
                                <td valign="middle" align="left">
                                    <input type="text" name="email" value="{$email}" style="width: 220px;"></td>
                            </tr>
                            <tr>
                                <td colspan="2" style="height: 6px;"></td>
                            </tr>
                        ...
                        {if !$SessionRefererLogin && $smarty.const.CONF_AFFILIATE_PROGRAM_ENABLED eq 1}
                            <tr>
                                <td align="right" valign="middle">{$smarty.const.CUSTOMER_AFFILIATION}:&nbsp;</td>
                                <td valign="middle" align="left">
                                    <input type="text" style="width: 220px;" name="affiliationLogin" value="{$affiliationLogin}">
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" style="height: 6px;"></td>
                        ...
                        {if $SessionRefererLogin || $smarty.const.CONF_AFFILIATE_PROGRAM_ENABLED eq 0}
                            <input name="affiliationLogin" type="hidden" value="{$SessionRefererLogin}">{/if}

                        {if $countries}
                            <tr>
                                <td align="right" valign="middle">
                                    <span class="error">*</span> {$smarty.const.CUSTOMER_COUNTRY}:&nbsp;</td>
                                <td valign="middle" align="left">
                        ...
                        {if $smarty.const.CONF_ADDRESSFORM_STATE ne 2}
                            <tr>
                                <td align="right" valign="middle">{if $smarty.const.CONF_ADDRESSFORM_STATE eq 0}<span class="error">*</span> {/if}{$smarty.const.CUSTOMER_STATE}:&nbsp;
                                </td>
                        ...
                        {if $smarty.const.CONF_ADDRESSFORM_CITY ne 2}
                            <tr>
                                <td align="right" valign="middle">{if $smarty.const.CONF_ADDRESSFORM_CITY eq 0}<span class="error">*</span> {/if}{$smarty.const.CUSTOMER_CITY}:&nbsp;
                                </td>
                                <td valign="middle" align="left">
                                    <input type="text" style="width: 220px;" name="city" value="{$city}" onblur='billingAddressCheckHandler()' onchange='billingAddressCheckHandler()'>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" style="height: 6px;"></td>
                        ...
                        {if $smarty.const.CONF_ADDRESSFORM_ADDRESS ne 2}
                            <tr>
                                <td align="right" valign="middle">{if $smarty.const.CONF_ADDRESSFORM_ADDRESS eq 0}<span class="error">*</span> {/if}{$smarty.const.CUSTOMER_ADDRESS}:&nbsp;
                                </td>
                                <td valign="middle" align="left">
                                    <textarea name="address" onchange='billingAddressCheckHandler()' style="height: 80px; width: 280px;">{$address}</textarea>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" style="height: 6px;"></td>
                        ...
                        {if $smarty.const.CONF_ENABLE_CONFIRMATION_CODE eq 1}
                            ...
                            <tr>
                                <td></td>
                                <td align="left" valign="middle">
                                    <input name="fConfirmationCode" value="{$smarty.const.STR_ENTER_CCODE}" type="text" style="width: 220px; color: #aaaaaa;" onfocus="if(this.value=='{$smarty.const.STR_ENTER_CCODE}')
                                    {literal}
                        ...
                        <tr>
                            <td></td>
                            <td align="left" valign="middle">
                                <a href="#" onclick="document.getElementById('RegisterForm').submit(); return false">{$smarty.const.OK_BUTTON3}</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="#" onclick="document.getElementById('RegisterForm').reset(); return false">{$smarty.const.RESET_BUTTON}</a>
                            </td>
                        </tr>
                    </table>
                    {literal}
