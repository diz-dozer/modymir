...
{if $answer}
    <form action='{$return_url}&amp;answer={$discussion.DID}' method=post id="ansform">
        <table class="adn">
            <tr>
                <td align="left" valign="top">
                    <span class="titlecol2">{$smarty.const.ADMIN_DISCUSSIONS_ANS}: {$discussion.product_name}</span>
                </td>
            </tr>
        </table>
        <table class="adn">
        ...
        <table class="adn">
            <tr>
                <td align="left" valign="top"><span class="titlecol2">{$smarty.const.ADMIN_ANSWER_TO_DISCUSSION}</span>
                </td>
            </tr>
        </table>
        <table class="adn">
        ...
        <table class="adn">
            ...
            <tr class="lins">
                <td align="left">
                    <input type=text style="width: 190px;" name='newAuthor' class="textp" value='{$smarty.const.ADMIN_DISCUSSIONS_ADMIN}'>
                </td>
                <td align="left">
                    <input type=text style="width: 380px;" name='newTopic' class="textp" value='Re: {$discussion.Topic}'>
                </td>
            </tr>
        </table>
        <table class="adn">
...
{else}
    <form action='{$smarty.const.ADMIN_FILE}' method=post name=MainForm>
        {if $products}
            ...
            &nbsp;&nbsp;&nbsp;
            <b>{$smarty.const.ADMIN_DISCUSSIONS_SELECT}</b>
            <table class="adn">
                <tr>
                    <td class="se6"></td>
                </tr>
            ...
            <tr class="lineb">
            <td align="left">
                <a href='{$urlToSort}&amp;sort=add_time&amp;direction=DESC' class="liv">{$smarty.const.ADMIN_DISCUSSION_ADDITION_TIME}</a>
            </td>
            <td align="left" width="40%">
                <a href='{$urlToSort}&amp;sort=product_name&amp;direction=ASC' class="liv">{$smarty.const.TABLE_PRODUCT_NAME}</a>
            </td>
            <td align="left">
                <a href='{$urlToSort}&amp;sort=Author&amp;direction=ASC' class="liv">{$smarty.const.DISCUSSION_NICKNAME}</a>
            </td>
            <td align="left" class="toph3">
                <a href='{$urlToSort}&amp;sort=Topic&amp;direction=ASC' class="liv">{$smarty.const.DISCUSSION_SUBJECT}</a>
            </td>
            ...
            {section name=i loop=$discussions}
                ...
                <tr class="liney">
                    ...
                    <td align="center">
                        <a href="#" onclick="confirmDelete({$discussions[i].DID},'{$smarty.const.QUESTION_DELETE_CONFIRMATION}', '{$fullUrl}&amp;delete=');">X</a>
                    </td>
                </tr>
                {sectionelse}
                <tr>
            <td colspan="7" align="center" height="20">{$smarty.const.STRING_EMPTY_LIST}</td></tr>
            {/section}
            {if $navigator}
                <tr>
        ...
        {else}
            <table class="adn">
                ...
                <tr>
                    <td align="center" valign="middle" height="24">{$smarty.const.STRING_EMPTY_LIST}</td>
                </tr>
            </table>
            <table class="adn">
                <tr>
