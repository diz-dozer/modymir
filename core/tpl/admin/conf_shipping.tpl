<form action="{$smarty.const.ADMIN_FILE}" method=post name="shipform" id="shipform">
        ...
        <table class="adn">
            ...
            {section name=i loop=$shipping_types}
                ...
                <tr class="liney">
                    ...
                    <td align="left">
                        <input type=text name=name_{$shipping_types[i].SID} value="{$shipping_types[i].Name|replace:'"':'&quot;'}" class="textp" size="28">
                    </td>
                    <td align="left">
                        <textarea name="description_{$shipping_types[i].SID}" style="height: 44px; width: 180px;">{$shipping_types[i].description|replace:'"':'&quot;'}</textarea>
                    </td>
                    <td align="left">
                        <textarea name="email_comments_text_{$shipping_types[i].SID}" style="height: 44px; width: 180px;">{$shipping_types[i].email_comments_text|replace:'"':'&quot;'}</textarea>
                    </td>
                    ...
                    <td align="left">
                        <input type=text name=sort_order_{$shipping_types[i].SID} value="{$shipping_types[i].sort_order|replace:'"':'&quot;'}" class="textp" size="8">
                    </td>
                    <td align="center">
                        <a href="#" onclick="confirmDelete({$shipping_types[i].SID},'{$smarty.const.QUESTION_DELETE_CONFIRMATION}','{$smarty.const.ADMIN_FILE}?dpt=conf&amp;sub=shipping&amp;delete=');">X</a>
                    </td>
                </tr>
                <tr>
                    <td height="4"></td>
    ...
    <table class="adn">
        ...
        <tr class="liney">
            ...
            <td align="left"><textarea name="new_email_comments_text" style="height: 44px; width: 180px;"></textarea>
            </td>
    ...
    <input type=hidden name=dpt value=conf> <input type=hidden name=sub value=shipping>
