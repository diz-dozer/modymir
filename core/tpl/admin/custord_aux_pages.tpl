...
<form action='{$smarty.const.ADMIN_FILE}?dpt=custord&amp;sub=aux_pages&amp;edit={$aux_page.aux_page_ID}' method=post name="formaxp" id="formaxp">
    ...
    <form action='{$smarty.const.ADMIN_FILE}?dpt=custord&amp;sub=aux_pages&amp;add_new=yes' method=post name="formaxp" id="formaxp">
        ...
        <table class="adn">
            <tr class="linsz">
                <td align="left" style="padding-top: 0;"><span class="titlecol2">{$smarty.const.AUX_PAGE_NAME}</span>
                </td>
            </tr>
            <tr>
                <td align="left">
                    <input name="aux_page_name" type="text" value='{$aux_page.aux_page_name}' style="width: 500px;" class="textp">
                </td>
            </tr>
            <tr>
                <td class="se5"></td>
            ...
            <tr class="linsz">
                <td align="left" style="padding-top: 0;">
                    <span class="titlecol2">{$smarty.const.ADMIN_PRODUCT_TITLE_PAGE}</span></td>
            </tr>
            <tr>
                <td align="left">
                    <input name="aux_page_title" type="text" value='{$aux_page.aux_page_title}' style="width: 500px;" class="textp">
                </td>
            </tr>
        ...
        </table>{else}</table><input type="hidden" name="aux_page_text_type" value="1">{/if}
        <table class="adn">
            <tr>
                <td class="se5"></td>
            </tr>
            ...
            <tr>
                <td width="50%">
                    <table class="adn">
                        ...
                        <tr>
                            <td align="left">
                                <textarea name='meta_description' id='meta_description' class="adminall" style="margin-right: 38px;">{$aux_page.meta_description}</textarea>
                            </td>
                        </tr>
                    </table>
                </td>
                <td width="50%">
                    <table class="adn">
                        ...
                        <tr>
                            <td align="left">
                                <textarea name='meta_keywords' id='meta_keywords' class="adminall">{$aux_page.meta_keywords}</textarea>
                            </td>
                        </tr>
                    </table>
                </td>
    ...
    <table class="adn">
        <tr>
            <td class="help"><span class="titlecol2">{$smarty.const.USEFUL_FOR_YOU}</span>
                ...
                <div class="helptext">{$smarty.const.ALERT_ADMIN21}</div>
            </td>
        </tr>
    </table>