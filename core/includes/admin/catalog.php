...
$admin_dpt = array(
    ...
    (
       ...
       // array("id" => "xml_import", "name" => ADMIN_IMPORT_FROM_XML),
...
if ($dpt == "catalog") {
    ...
    if (file_exists("core/includes/admin/sub/" . $admin_dpt["id"] . "_$sub.php")) //sub-department file exists
    {
        ...
        $smarty->assign("admin_main_content_template", $admin_dpt["id"] . ".tpl");
        //assign subdepts
        ...
        $smarty->assign("admin_main_content_template", "notfound.tpl");
}
