...
?>
            ...
            function OnClickCheckButton(numberCheck) {
                document.getElementById('default_radiobutton_' + numberCheck).disabled = !document.getElementById('switchOn_' + numberCheck).checked;
                document.getElementById('price_surplus_' + numberCheck).disabled = !document.getElementById('switchOn_' + numberCheck).checked;
        ...
        <tr class="lineb">
            <td align="center" valign=middle>
                <input type="checkbox" class="round" id="id_chbGroup" onclick="chbCol.changeState()"></td>
            <td align="center"><?php
                echo ADMIN_BY_DEF;
                ?></td>
            <td align="center"><?php
        ...
        while ($value_row = db_fetch_row($values)) {
            ...
            <tr>
                <td align="center" height="26"><input name="switchOn_<?php
                    ...
                    ?>" type="checkbox" class="round" id="switchOn_<?php
                    echo $value_row["variantID"]
                    ?>">
                </td>
